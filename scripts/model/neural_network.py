...
def initialize_parameters():
    ...
    W1 = tf.get_variable('W1', [6, 10], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
    b1 = tf.get_variable('b1', [6, 1], initializer = tf.zeros_initializer())
    W2 = tf.get_variable('W2', [4, 6], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
    ...
    b3 = tf.get_variable('b3', [3, 1], initializer = tf.zeros_initializer()) #Tried 2 but error occured. Should match # of class
    ### END CODE HERE ###
...
def model(x_train, y_train, x_test, y_test, learning_rate = 0.0001,
    ...
    with tf.Session() as sess:
        ...
        plt.show()
        plt.savefig('Cost_nn.png') # didn't work. so saved manually
